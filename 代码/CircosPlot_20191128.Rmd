...
Circos.Data<-Circos.Data[!duplicated(Circos.Data),]#1248个基因

Plot.Circos.Data<-Circos.Data[!is.na(Circos.Data$seqnames),]#1217个基因
Plot.Circos.Data<-Plot.Circos.Data[!is.na(Plot.Circos.Data$log2FoldChange),]#456个基因
Plot.Circos.Data<-Plot.Circos.Data[!is.na(Plot.Circos.Data$adjp),]#456个基因
Plot.Circos.Data<-Plot.Circos.Data[!is.na(Plot.Circos.Data$Number_of_Samples_Mutations),]#449个基因
Plot.Circos.Data<-Plot.Circos.Data[!is.na(Plot.Circos.Data$Number_of_Samples_CNA),]#403个基因
...
tp1<-which(gene.adjp$adjp<0.05)
gene.adjp$adjp[tp1]<-0
gene.adjp$adjp[-tp1]<-1
...
pdffile  <- "Circos_melanoma_20191128.pdf";
pdf(pdffile, 10, 10);
par(mar = c(1, 1, 1, 1));
...
circos(R = 290,cir = "hg19",W = 20,mapping = gene.adjp,col.v = 4,type = "heatmap",B = FALSE,lwd = 2,scale = TRUE,col.bar = TRUE,col.bar.po = "bottomright");#第三层p值热图
...
leg.txt<-c("log2FoldChange","adjp","Number_of_Samples_Mutations","Number_of_Samples_CNA");
