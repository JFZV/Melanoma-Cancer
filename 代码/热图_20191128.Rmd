...
draw(ht1,heatmap_legend_side = "bottom",annotation_legend_side = "bottom",merge_legend = TRUE);
dev.off()
```
...
ha = HeatmapAnnotation(type = factor(str_extract(colnames(mat2),"[A-Z]+")),
                       annotation_legend_param = list(title = "Patient Type",
                                     at = c("TAM","NT","TM","TP"),
                                     labels = c("Additional Metastatic","Solid Tissue Normal","Metastatic","Primary Solid Tumor"),
                                  );
...
draw(ht2,heatmap_legend_side = "bottom",annotation_legend_side = "bottom",merge_legend = TRUE);
dev.off()
```
